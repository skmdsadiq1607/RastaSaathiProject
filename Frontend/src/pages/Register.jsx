    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '2.5rem', marginBottom: '8px' }}>{t('register_title')}</h1>
          <p style={{ color: 'var(--text-secondary)' }}>{t('register_sub')}</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '32px', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
          {t('have_account')} <Link to="/login" style={{ color: 'var(--accent-blue)', textDecoration: 'none', fontWeight: '600' }}>{t('login')}</Link>
        </p>
      </motion.div>
    </motion.div>
  );
