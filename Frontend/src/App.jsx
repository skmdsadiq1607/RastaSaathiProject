...
const App = () => {
  ...
  return (
    <ThemeProvider>
      <div className="page-wrapper" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
  
        <nav className="glass-nav">
          <div className="container" style={{ display: 'flex', alignItems: 'center', width: '100%', height: '80px' }}>
            {/* Logo Section */}
            <Link to="/" style={{ textDecoration: 'none', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', marginRight: '30px' }}>
              <Logo size={32} />
            </Link>
            ...
            <div className="desktop-menu" style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', gap: '20px', alignItems: 'center' }}>
                {!isLoggedIn ? (
                  <>
                    <Link to="/login" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: '700', fontSize: '0.85rem' }}>{t('login')}</Link>
            ...
            {!isMenuOpen && (
              <div className="mobile-only-ui" style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '15px' }}>
                <ThemeToggle />
                {isLoggedIn && (
                  <Link to="/profile" className="mobile-profile-link" style={{ color: 'var(--text-primary)' }}>
                    <User size={24} />
                  </Link>
                )}
                <button
              ...
              <>
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexShrink: 0 }}>
                    ...
                    <button
                      onClick={() => setIsMenuOpen(false)}
                      style={{ background: 'var(--glass-bg)', border: 'none', borderRadius: '50%', width: '48px', height: '48px', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                    >
                      <X size={28} />
                    </button>
                  </div>
                  ...
                  <div style={{ height: '1px', background: 'var(--border-glass)', margin: '20px 0', flexShrink: 0 }}></div>
                  ...
                  <div style={{ marginTop: '30px', padding: '30px', background: 'var(--glass-bg)', borderRadius: '32px', border: '1px solid var(--border-glass)', marginBottom: '30px' }}>
          ...
          <div className="container">
            <div style={{ 
              ...
              <div style={{ flex: '1.5', minWidth: '320px' }}>
                <div style={{ color: 'var(--text-primary)', fontWeight: '900', fontSize: '1.8rem', letterSpacing: '1px', marginBottom: '24px' }}>
                  <Logo size={32} />
                </div>
                <h3 style={{ 
                  fontSize: '2rem', 
              ...
              <div style={{ 
                ...
                <h4 style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '25px', opacity: 0.5 }}>Connect</h4>
            ...
            <div style={{ borderTop: '1px solid var(--border-glass)', paddingTop: '40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px', textAlign: 'center' }}>
              <div style={{ color: 'var(--text-primary)', fontWeight: '800', fontSize: '1.2rem', letterSpacing: '1px' }}>
                <Logo size={24} />
              </div>
