...
async function dispatchAlerts({ io, incident, victimUser, severityLevel, hospitalName, hospitalLocation, policeName, policeLocation, ambulanceName, ambulanceLocation, etaSeconds, lang }) {
  ...
  for (const c of contacts) {
    const smsBody = t(lang, 'sms.SOS', {
      ...
      ambulance: ambulanceName || 'Locating...',
